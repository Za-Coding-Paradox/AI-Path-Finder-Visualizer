...
COLOR_DYNAMIC = pygame.Color("#f38ba8") # Dynamic Obstacle (Red)
COLOR_START = pygame.Color("#a6e3a1")   # Start (Green)
COLOR_TARGET = pygame.Color("#fab387")  # Target (Orange)
...
STEP_DELAY = 0.05            # Seconds between expansion steps
